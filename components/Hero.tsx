  ...
  return (
    <div className="relative pt-32 pb-12 md:pt-48 md:pb-20 text-center px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-6 animate-fade-in">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/80 border border-slate-800 text-xs font-medium text-med-primary mb-4 animate-fadeIn">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6 leading-tight">
          加速您的 <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-med-primary to-blue-400">
            医学研究
          </span>
        </h1>
